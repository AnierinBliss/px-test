...
public class Resources {
     ...
     * is at least one pixel in size and applying a scale factor.
     * 
     * @param id The desired resource identifier, as generated by the aapt
     *           tool. This integer encodes the package, type, and resource
     *           entry. The value 0 is an invalid identifier.
     ...
     * @see #getDimension
     * @see #getDimensionPixelOffset
     * @see DisplayUtils#getScaleFactor(Context)
     */
    public int getDimensionPixelSize(@DimenRes int id) throws NotFoundException {
        ...
        try {
            ...
            impl.getValue(id, value, true);
            if (value.type == TypedValue.TYPE_DIMENSION) {
                float scaleFactor = DisplayUtils.getScaleFactor(impl.getContext());
                int dimensionPixelSize = TypedValue.complexToDimensionPixelSize(
                        value.data, impl.getDisplayMetrics());
                dimensionPixelSize *= scaleFactor;
